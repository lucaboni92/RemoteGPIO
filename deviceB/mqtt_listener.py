...
def on_connect(client, userdata, flags, rc):
	...
	client.subscribe("cmnd/deviceB/BCM17")
	client.subscribe("cmnd/deviceB/BCM27")
	client.subscribe("cmnd/deviceB/BCM22")
	client.subscribe("cmnd/deviceB/BCM10")
	
	# INPUT BCM PINS: 5,6,13,19
	# client.subscribe("cmnd/deviceB/BCM5")
	# client.subscribe("cmnd/deviceB/BCM6")
	# client.subscribe("cmnd/deviceB/BCM13")
	# client.subscribe("cmnd/deviceB/BCM19")
	...
	if mqtt_cmd_type == "cmnd":
		...
		if pin != "unknown":
			if str(msg.payload) == "HIGH" or str(msg.payload) == "1":
				GPIO.output(pin, GPIO.LOW) #HIGH = realy OFF - LOW = relay ON
